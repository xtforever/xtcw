...
\Section
Das Widget {\tt Wsel} kann zur auswahl eines Wertes aus einer Stringlist
  verwendet werden
...
{\lbrace}
    ...
    printf( "{\percent}s: {\percent}u {\percent}u{\backslash}n",{\dollar}name, ((unsigned char*)s)[0], ((unsigned char *)s)[1] );
